    ...
    connect() {
        ...
        function checkLastYellowChar(char, tempLetterOccurences) {
            ...
            if (tempLetterOccurences[char] == 0) {
                ...
                let td = document.querySelector("#grid > tr[" + currentLine + "] > td")[i - 1];
        ...
        function checkLine(player) {
            ...
            for (let i = 0; i < inputContent.length; i++) {
                ...
                let td = document.querySelector("#grid > tr[" + currentLine + "] > td")[i];
        ...
        function jumpLine() {
            let td = document.querySelector("#grid > tr[" + currentLine + "] > td").innerHTML = " ";
            td.innerHTML = " ";
        ...
        function keyInput (e) {
            if (e.keyCode === 13) {  // Enter
                ...
                currentColumn--;
                document.querySelector("#grid > tr[" + currentLine + "] > td")[currentColumn].innerHTML = '.';
            } else if ((e.keyCode >= 65 && e.keyCode <= 90) || e.keyCode >= 48 && e.keyCode <= 57) { // a-z 0-9
                var char = String.fromCharCode(e.which);

                console.log("line = "+ column);
                console.log("column = "+ currentLine);

                document.querySelector("#grid tr:nth-of-type(" + currentLine+1 + ") td")[currentColumn].innerHTML = char;
                currentColumn++;
