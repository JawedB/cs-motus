    ...
    connect() {
        ...
        function checkLastYellowChar(char, tempLetterOccurences) {
            ...
            if (tempLetterOccurences[char] == 0) {
                ...
                let td = document.querySelectorAll("#grid tr:nth-of-type(" + currentLine+1 + ") > td")[i - 1];
        ...
        function checkLine(player) {
            ...
            for (let i = 0; i < inputContent.length; i++) {
                ...
                let td = document.querySelectorAll("#grid tr:nth-of-type(" + currentLine+1 + ") > td")[i];
        ...
        function jumpLine() {
            let td = document.querySelectorAll("#grid tr:nth-of-type(" + currentLine+1 + ") > td").innerHTML = " ";
            td.innerHTML = " ";
        ...
        function keyInput (e) {
            if (e.keyCode === 13) {  // Enter
                ...
                currentColumn--;
                document.querySelectorAll("#grid tr:nth-of-type(" + currentLine+1 + ") td")[currentColumn].innerHTML = '.';
                ...
                document.querySelectorAll("#grid tr:nth-of-type(" + currentLine+1 + ") td")[currentColumn].innerHTML = char;
                currentColumn++;
