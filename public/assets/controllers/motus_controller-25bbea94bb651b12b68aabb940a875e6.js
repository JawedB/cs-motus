...
export default class extends Controller {
    connect() {
        ...
        document.getElementsByClassName("result").style.visibility = "none";
        ...
        function keyInput (e) {
            if (e.keyCode === 13) {  // Enter
                ...
                currentColumn--;
                $("#grille tr:eq(" + currentLine + ") td").eq(currentColumn).html('.');
            } else if ((e.keyCode >= 65 && e.keyCode <= 90) || e.keyCode >= 48 && e.keyCode <= 57) { // a-z 0-9
                var char = String.fromCharCode(e.which);
                $("#grille tr:eq(" + currentLine + ") td").eq(currentColumn).html(char);
                currentColumn++;
