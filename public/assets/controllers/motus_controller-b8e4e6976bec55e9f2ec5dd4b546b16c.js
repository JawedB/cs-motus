...
export default class extends Controller {
    connect() {
        ...
        function checkLine(player) {
            ...
            let tempLetterOccurences = letterOccurences.map(function(arr) {
                return arr.slice();
            });

            for (var key in tempLetterOccurences) {
                console.log(key + " " + tempLetterOccurences[key]);
            }
        ...
        for (let i = 0; i < player.length; i++) {
            ...
            console.log("letterOccurences["+player[i]+"] = " + letterOccurences[player[i]]);
        }
